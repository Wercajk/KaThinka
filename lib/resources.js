...
res.buildModels = function() {
  ...
  while (i--) {
    ...
    if ( resource.blueprint.schema_options && typeof resource.blueprint.schema_options.middleware == "function" ) {
      resource.blueprint.schema_options.middleware(schema);
    }

    resource.model = mongoose.model(name, schema);

    if ( resource.blueprint.schema_options && typeof resource.blueprint.schema_options.onInit == "function" ) {
